 ...
 *
 * Just: "${PATH_TO_BINARY}/p1 --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class p1 : public RoboComp::Application
{
public:
	p1 (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
